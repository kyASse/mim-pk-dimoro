...
describe('PendaftarTabsContent Component', () => {
  ...
  it('supports controlled active tab or tab navigation', () => {
    render(<PendaftarTabsContent pendaftar={mockPendaftar} defaultTab="orangtua" />);
  ...
  it('renders administrasi tab content when selected', () => {
    render(<PendaftarTabsContent pendaftar={mockPendaftar} defaultTab="administrasi" />);
    expect(screen.getByText(/Manajemen Akun Portal Wali Murid/i)).toBeDefined();
  });
});
