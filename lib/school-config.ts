 ...
 */
export const SCHOOL_SHORT_NAME = "MIM Dimoro";

/**
 * Deskripsi singkat untuk metadata SEO dan hero section.
 */
export const SCHOOL_DESCRIPTION =
  "Website resmi MI Muhammadiyah Dimoro: informasi madrasah, pendaftaran, berita, galeri, dan portal orang tua.";

/**
 * Deskripsi panjang untuk seksi About di Beranda.
 */
export const SCHOOL_ABOUT_DESCRIPTION =
  "MI Muhammadiyah Dimoro adalah madrasah ibtidaiyah yang berkomitmen memberikan pendidikan berkualitas " +
 ...
 * Alt text untuk logo.
 */
export const SCHOOL_LOGO_ALT = "Logo MI Muhammadiyah Dimoro";
